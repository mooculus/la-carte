...
\begin{example}[Streaming Service]
...
\begin{tikzpicture}[]
     \matrix (matA) [%
      ...
      \draw[black,ultra thick] (matA-1-1.west)  -- (matA-1-5.east);
      \draw[black,ultra thick] (matA-2-1.west) -- (matA-2-5.east);
      ...
      \draw[black,ultra thick] (matB-1-1.north)  -- (matB-5-1.south);
      \draw[black,ultra thick] (matB-1-2.north) -- (matB-5-2.south);
      \draw[black,ultra thick] (matB-1-3.north) -- (matB-5-3.south);
...
\end{tikzpicture}
\end{center}
Above we are attempting to concisely show the dot product in the
matrix product.
...
\begin{tikzpicture}[]
     \matrix (matA) [%
      ...
      \draw[black,ultra thick] (matA-1-1.north)  -- (matA-2-1.south);
      \draw[black,ultra thick] (matA-1-2.north)  -- (matA-2-2.south);
      \draw[black,ultra thick] (matA-1-3.north)  -- (matA-2-3.south);
      \draw[black,ultra thick] (matA-1-4.north)  -- (matA-2-4.south);
      \draw[black,ultra thick] (matA-1-5.north)  -- (matA-2-5.south);
      ...
      \draw[black!20!white,line width=1em,line cap=round] (matB-1-1.north)  -- (matB-5-1.south);
      \draw[black!20!white,ultra thick,line width=1em,line cap=round] (matB-1-2.north) -- (matB-5-2.south);
      \draw[black!20!white,ultra thick,line width=1em,line cap=round] (matB-1-3.north) -- (matB-5-3.south);
      
      \node[right=2ex of matB] {$=\begin{pmatrix}
  \boldsymbol{|\cdot|\cdot|\cdot|\cdot|\cdot} & \boldsymbol{\mid\cdot\mid\cdot\mid\cdot\mid\cdot\mid\cdot} &|\cdot|\cdot|\cdot|\cdot|\cdot \\
        \end{pmatrix}$};
      \matrix (matBp) [%
        matrix of nodes,right=of matA,
       left delimiter={(},right delimiter={)}
