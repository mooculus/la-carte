...
If on the other hand, $\vec{x}$ and $\vec y$ are $n$-vectors again
with
\begin{itemize}
\item $\vec{x}$ expressed as a row,
\item $\vec{y}$ expressed as a column,
...
\begin{example}[Normal distribution]
  We encode a vector with data that follows a normal distribution, and data that follows a skewed normal distribution:
  \begin{align*}
    \vec{n} &=\begin{pmatrix} 0.11 & 0.22 & 0.39 & 0.58 & 0.74 & 0.8 & 0.74 & 0.58 & 0.39 & 0.22 & 0.11 \end{pmatrix}\\
    \vec{s} &=\begin{pmatrix} 0.11 & 0.22 & 0.39 & 0.58 & 0.74 & 0.8 & 0.74 & 0.58 & 0.39 & 0.22 & 0.11 \end{pmatrix}
  \end{align*}
  \[
  \vec{n} =\begin{pmatrix} 0.11 & 0.22 & 0.39 & 0.58 & 0.74 & 0.8 & 0.74 & 0.58 & 0.39 & 0.22 & 0.11\end{pmatrix}%& 0.11 \end{pmatrix}
  \]
    \begin{center}
\newcommand{\matrixData}{{
{0.11, 0.22, 0.39, 0.58, 0.74, 0.8, 0.74, 0.58, 0.39, 0.22, 0.11}
    ...
    \begin{tikzpicture}[scale=.5]
        \foreach \x in {0, 1, ..., 10} {
          ...
          \fill[black, opacity={1-\val}] (\x, 0) rectangle (\x+1, 0-1);
          \draw (\x, 0) rectangle (\x+1, 0-1);
        }
    \end{tikzpicture}
    \end{center}
    \begin{explanation}
...
%% \end{example}
  ...
  numerous applications, from traffic networks to circuts, to actual computer networks. 
