...
\begin{question}
  ...
  \begin{selectAll}
    ...
    \choice[correct]{$2x^3 + xy^2 - 3y^2z = 0$}
    \choice{$2x + y - 3 = 0$}
    \choice[correct]{$2x + y - 3z = 0$}
  \end{selectAll}
\end{question}
...
\begin{definition}
  The \dfn{null space} (or \dfn{kernel}) of a $m\times n$ matrix $M$
  is the set of all solutions to $M\vec{x} = \vec{0}$. We can express
  this as
  \[
