...
\begin{exercise}
  ...
  % \textcolor{blue}{better to just say vector than 3-vector} --> TK:
  % the expression `3-vector' is a common way of saying that it is an
  % element of $\mathbb{R}^3$.
  3-vector $\vec{p}$ represents the \link[official gray
