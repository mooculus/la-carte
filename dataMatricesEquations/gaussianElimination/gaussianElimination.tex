...
\begin{center}
\begin{tikzpicture}
  \draw[line width=1.3em,black!15!white] (-2.1,.455) -- (1.9,.455);
  \draw[line width=1.3em,black!15!white] (-.8,.025) -- (1.9,.025);
  \draw[line width=1.3em,black!15!white] (.7,-.42) -- (1.9,-.42);
...
\quad\begin{tikzpicture}
  \draw[line width=13pt,black!15!white] (-.7,.455) -- (.45,.455);
...
\quad
\begin{tikzpicture}
  \draw[line width=1.3em,black!15!white] (-1.6,.455) -- (1.4,.455);
  \draw[line width=1.3em,black!15!white] (-1,.025) -- (1.4,.025);
  \draw[line width=1.3em,black!15!white] (-.4,-.42) -- (1.4,-.42);
\node at (0,0) {$\begin{pmatrix}
  ~1~ &   3 & -3 & ~2~  \\
  0 &   3 & -3 & ~-3~ \\
  0& 0  & 2 & 6
...
\begin{example}[None, one, many]
  ...
  \begin{explanation}
    ...
    \[
    \begin{matrix}\scriptstyle-3R_{1}+R_{3}\rightarrow R_{3}\\\Longrightarrow\\\scriptstyle-2R_{1} + R_{2}\rightarrow R_{2}\end{matrix}
    \left(\begin{array}{ccc|c}
      \answer[given]{1} &  \answer[given]{1} &  \answer[given]{1} &  \answer[given]{1} \\
