...
information about the system of equations, incluing the solutions.  We
...
\end{tikzpicture}
\]
We've made a stair step patteren in each matrix. Now let's make a defintion.

\begin{definition}
We say a matrix $M$ is in \dfn{row eschelon form} if every nonzero row
...
\subsection{How does row ecehelon form help?}

Let's think about our original system of equations. We've shown that
this cooresponds to a matrix in row eschelon from:
\[
\begin{array}{ccccccc}
       & & 3y &-& 3z &=& 2 \\
     x& +&3y&-&3z&=&-3\\
...
cooresponds to the following system of equations:
\[
\left(\begin{array}{ccc|c}
  1 &   3 & -3 & 2  \\
  0 &   3 & -3 & -3 \\
