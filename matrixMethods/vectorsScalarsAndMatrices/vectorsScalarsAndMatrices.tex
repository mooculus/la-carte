...
\begin{definition}
  ...
  and $\vec{w}$ do.
\end{definition}
This informal defintion in fact contains the \textit{essence} of the
...
\]
We give the `dimensions' of a matrix by stating its number of rows and
colums. Rows come first and columns come second, so $M$ above is a
$(4\times 5)$-matrix.
...
Babysteps to multiplying matrices! We'll start by multiplying a $(1\times 3)$-matrix by a $(3\times 1)$ matrix
\[
