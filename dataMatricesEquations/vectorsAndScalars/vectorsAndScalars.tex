...
\hat{\vec{v}}_2$. This notational convention will be used consistently
through the remainder of this textbook.
...
to the $1$-norm:
\[
  \hat{\vec{v}}_1 = \frac{\vec{v}}{\|\vec{v}\|_1} = \frac{\vec{v}}{\sum_{i=1}^n |v_i|}.
\]
...
$\vec{p}_{\mathtt{OH}}$ equals the sum of the
components:
\[
