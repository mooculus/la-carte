...
\begin{enumerate}
\item Here is a schematic drawing of what is happening:
...
\end{tikzpicture}   
  ...
  Converting the planes bearing and speed to a vector in cartesian
  coordinates, we have
  \[
...
eg
\]
We give the `dimensions' of a matrix by stating its number of rows and colums:
\[
diagram rows columns
\]
Rows come first and columns come second.
