...
\begin{example}[RGB Color Space]
  ...
  \begin{explanation}
    ...
    \[
      ...
      \end{pmatrix}
    \]
    The meaning of the $(2,3)$-entry is BADBAD \textcolor{blue}{I
      think interpreting the entry is not that great here: The
      (2,3)-entry is the intensity of green color in green.}
