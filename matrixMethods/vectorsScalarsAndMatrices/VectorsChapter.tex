...
\title{\textcolor{blue}{Vectors}}


\begin{document}
\begin{abstract}
  \textcolor{blue}{A concrete introduction to vectors along with some examples of real world applications.}
\end{abstract}
\maketitle
...
\item[RGB Color Space] Colors on digital screens are often represented
  ...
  representing no \textcolor{blue}{intensity}, black can be represented by $(0,0,0)$,
...
\begin{definition}
  To switch a row vector into a column vector and vice versa, we use the \dfn{transpose} operation\textcolor{blue}{, referred to as the transpose of the vector,}
  \[
