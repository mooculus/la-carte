...
\end{array}\right).
\]
Some folks call this an \dfn{augmented matrix}, and they write stuff like this:
\[
...
\end{pmatrix}
\]
All represent solutions to the system of equations:
\[
\begin{array}{ccccccc}
       & & 3y &-& 3z &=& 2 \\
     x& +&3y&-&3z&=&-3\\
...
\end{array}
\]
Some `forms' of these matrices are more convient than others. One form
of matrix is called \dfn{row echelon form} or \dfn{triangular
