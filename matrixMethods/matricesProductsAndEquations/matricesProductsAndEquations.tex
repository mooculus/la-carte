...
\begin{example}[RGB Color Space]
  ...
  \begin{explanation}
    ...
    placing the vectors side-by-side: \textcolor{blue}{this is not right. I think the vectors here are from another example. I gave the correct one}
    \[
    \begin{pmatrix}
    ...
    0 & 0 & 0 & 255 & 255 & 255 
    \end{array}\right)\]}
    The meaning of the $(2,3)$-entry is BADBAD \textcolor{blue}{I think interpreting the entry is not that great here: The (2,3)-entry is the intensity of green color in green.}
  \end{explanation}
\end{example}
