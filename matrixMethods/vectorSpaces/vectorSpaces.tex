...
them \textit{homogeneous} because all the (nonzero) terms are multiplied by the same powers of variables For example:
\[
\underbrace{2x^3 + y^2 - 3z = 0}_{\text{NOT homogeneous}}\qquad \underbrace{2x + y - 3 = 0}_{\text{NOT homogeneous}}
\]
\[
\underbrace{2x^3 + xy^2 - 3y^2z = 0}_{\text{homogeneous}}\qquad \underbrace{2x + y - 3z = 0}_{\text{homogeneous}}
\]
