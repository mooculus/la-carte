...
\begin{prompt}
Based on part (\ref{infman:a}), the system has \wordChoice{\choice{no solutions} \choice{$x=0, y=0, z=0, w=0$} \choice[correct]{infinitely many solutions}\choice{$x=4, y=12, z=$ undefined, $w=$ undefined}} and using $w$ and $z$ we have,
\begin{align*}
