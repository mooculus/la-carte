...
\end{array}\right)
\]
Our goal is to convert our matrix to row echelon form. Noting that
changing the order of equations does not affect the solutions of the
system of equations, we note that neither does swapping the rows of the
augmented matrix. So we write:
\[
\left(\begin{array}{ccc|c}
  2 & 3 & 1 & 5 \\
  1 &  -2 & 2 &-9 \\
