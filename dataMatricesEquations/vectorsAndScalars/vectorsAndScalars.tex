...
\paragraph{Sums via dot product}
...
\begin{example}[RGB Color Space]
  ...
  \begin{explanation}
   ...
   \begin{align*}
     \hat\vec y &= \begin{pmatrix}181\\181\\0\end{pmatrix}\\
     \hat\vec c &= \begin{pmatrix}0\\181\\181\end{pmatrix}\\
     \hat\vec m &= \begin{pmatrix}181\\0\\181\end{pmatrix}
   \end{align*}
   Now we'll find unit vectors for each of these:
    Here are the actual colors:
    \begin{center}
      \begin{tikzpicture}
